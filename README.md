...
| Ajasta App        |                                                                                | Multi-tenant marketplace that provides an integrated platform for appointment booking, resource scheduling, and payment processing. It contains a Kotlin backend (microservices), a React frontend served by Nginx, and infrastructure to deploy to a cloud VMs (k8s) in one command.| [@rurikv](https://github.com/rurikv)             |              |
